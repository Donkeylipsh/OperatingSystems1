 ...
 * Date: 6/10/2018
 * Assignment: OTP
 * Description: otp_dec.c is a client application that decrypts an encrypted file using a server
 * 	to perform the decryption. otp_dec accepts as command line arguments the filename for the
 * 	file that contains the entrypted text, the filename for the key to decrypt the text, and 
 * 	the port for the server that will perform the decryption
 *************************************************************************************************/
